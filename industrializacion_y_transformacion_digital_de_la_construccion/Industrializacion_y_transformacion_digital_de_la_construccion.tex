...
OIR (Organizational Information Requirements): Requisitos de información de la organización, relativos a sus objetivos. Qué se pretende construir y para qué se va a construir.

PIR (Project Information Requirements): Requisitos de información del proyecto, relativos a su desarrollo. Qué información se va a necesitar y para qué usos se piensa utilizar.

\subsection{AIR, EIR : a la hora de cerrar un acuerdo o contrato}

AIR (Asset Information Requirements): Requisitos de información sobre el activo cuya construcción se va a contratar.

EIR (Exchange Information Requirements): Requisitos de intercambio de información entre las distintas partes participantes en el contrato. (Quién, cómo, cuándo presentar esa información.)

\subsection{PIM, AIM : durante la obra y al finalizarla}

PIM (Project Information Model): Detalle de la información que se ha de presentar, relativa al proceso de construcción. (La que se necesita para construir.)

AIM (Asset Information Model): Detalle de la información que se ha de presentar, relativa a la construcción terminada. (La que se necesita para operación y mantenimiento posteriores.)

\section{Diagrama resumen de flujos de información}
\includegraphics[width=1.2\textwidth]{Flujos_de_informacion_en_la_construccion_BIM}
